...
contract Ogwil is BaseGame {
         ...
         * 
         */
        function getChoiceResult(uint256 gameType, uint256 choice, uint256 lastWin, uint256 rand) 
                public
                view
                returns (uint256) {
         ...
         function mergeRands(uint256[] memory rand1, uint256[] memory rand2, uint256 gameType) 
                                                        public
                                                        view
                ...
                rand[0] = (rand1[0] + rand2[0]) % (gameType + 1);
                return rand;
        }
       
         function getRandLength(uint256)
                public
                view
        ...
        function doStep(
                ...
                require (8 == state.length, 'Error: Incorrect length');
        ...
        function finishAction(
                ...
                win = getChoiceResult(state[1], state[4], win, mergeRands(rand1, rand2, state[1])[0]);
