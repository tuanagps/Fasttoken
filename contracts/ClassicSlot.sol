...
contract ClassicSlot is BaseSlot {
        ...
        function doStep(
                ...
                /// TODO requires should be added for rands
        ...
        function startAction(uint256[] memory state, uint256[] memory action) 
                ...
                if (1 == action[1]) { // spin
                        ...
                        //TODO maybe set requires on bet and line for regular spin to be 0
                        if  (0 == state[7]) { 
                            ...
                            require(action[3] == state[3], 'Error: state[2] should be equal to action[2]');
                        }
        ...
        function finishAction(
                ...
                if (1 == state[1]) { // normal
                        ...
                        require(0 == state[4], 'Error: state[4] should be 0');
                        require(0 == state[6], 'Error: state[6] should be 0');
                        (win, numberOfFreeSpins) = getSpinResult(state[2], state[3], mergeRands(rand1, rand2, 1), state[7]);
                       ...
                       // require(0 == state[3], 'Error: state[3] should be 0');
                        require(0 != state[4], 'Error: state[4] should not be 0');
                        require(0 != state[6], 'Error: state[6] should not be 0');
                        win = getDoublingResult(state[4], state[6], (mergeRands(rand1, rand2, 2))[0]);
                }
